    ...
    App.Common = (function(){
        ...
        function init(){
            ...
            if(App.Common.settings[App.Common.sid].data.grid_options){
                var extend_grid_options = eval(App.Common.settings[App.Common.sid].data.grid_options)
        ...
        return {
            ...
            onCompanyChange: function(){
                ...
                if(+company>0){
                    frm.find('select[data-server-dropdown="1"] option[data-company!=""]').attr('disabled','1');
                    frm.find('select[data-server-dropdown="1"] option[data-company="'+company+'"]').removeAttr('disabled');
                }
